#------------------------------------------------------------------------------#
# Scenario 3 (Log-Normal incubation density, n = 40, coarseness = 2 day).      #
...
set.seed(1789) # French revolution

# Run simulation and extract summary
simobj <- perfIncubestim(nsim = 1000, n = 40, incubdist = "LogNormal",
                         coarseness = 2, K = 10)
