#------------------------------------------------------------------------------#
# Scenario 13 (Gamma incubation density, n = 40, coarseness = 1 day).           #
...
set.seed(1920) # The 1920s

# Run simulation and extract summary
simobj <- perfIncubestim(nsim = 1000, n = 40, incubdist = "Gamma",
                         coarseness = 1, K = 10)
