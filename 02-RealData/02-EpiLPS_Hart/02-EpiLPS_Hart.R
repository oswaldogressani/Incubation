...
write.xlsx(round(datacts,3), file = "Hart_continuous.xls")
...
# Extract plots
pdf(file = "Hart_Ibounds.pdf", width = 8, height = 4)
suppressWarnings(incub)
dev.off()

pdf(file = "Hart_pdf.pdf", width = 8, height = 4)
suppressWarnings(densplot)
dev.off()

pdf(file = "Hart_cdf.pdf", width = 8, height = 4)
