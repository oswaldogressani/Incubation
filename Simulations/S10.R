#------------------------------------------------------------------------------#
# Scenario 10 (Weibmix incubation density, n = 200, coarseness = 1 day).        #
...
set.seed(2020) # PhD year

# Run simulation and extract summary
simobj <- perfIncubestim(nsim = 1000, n = 200, incubdist = "MixWeibull",
                         coarseness = 1, K = 20)
