#------------------------------------------------------------------------------#
# Scenario 14 (Gamma incubation density, n = 200, coarseness = 1 day).        #
...
set.seed(2006) # Italy wins FIFA World Cup

# Run simulation and extract summary
simobj <- perfIncubestim(nsim = 1000, n = 200, incubdist = "Gamma",
                         coarseness = 1, K = 10)
